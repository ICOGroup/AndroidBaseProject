 ...
 */
public abstract class IcoBaseAdapter<T, VH extends IcoBaseHolder<T>> extends BaseAdapter {

    private Context context;
    private LayoutInflater mLayoutInflater;
    protected List<T> list = new ArrayList<>();
    protected Listener<T> listener;
    private IcoBaseHolder<T> holder;
    private int layout;

    public IcoBaseAdapter(Context context, int layout) {
        super();
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            holder = (IcoBaseHolder<T>) convertView.getTag();
        }
